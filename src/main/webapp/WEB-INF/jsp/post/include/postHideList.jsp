			...
			<div class="postImageBox">
				...
				<div class="comment">
					<div class="comment-header d-flex align-items-center justify-content-between">
						<div class="ml-2 small"><b>댓글</b></div>
						<i class="bi bi-caret-down-fill btn" id="carentDownBtn"></i>
						<i class="bi bi-caret-up-fill btn d-none" id="carentUpBtn"></i>
					</div>
					<div class="commentInfo mt-2">
						<div class="ml-3">
							<div class="d-none" id="longComment">
								<c:forEach var="comment" items="${post.commentList}">
									<div class="commentInfoBox small mt-1">
										<a href="/profile/view?userId=${comment.userId}"><b>${comment.nick_name.nick_name}</b></a> 
									${comment.comment}
									</div>
								</c:forEach>
							</div>
							<div id="shortComment">
								<c:forEach var="comment" items="${post.commentList}" end="1">
									<div class="commentInfoBox small mt-1">
										<a href="/profile/view?userId=${comment.userId}"><b>${comment.nick_name.nick_name}</b></a> 
									${comment.comment}
									</div>
